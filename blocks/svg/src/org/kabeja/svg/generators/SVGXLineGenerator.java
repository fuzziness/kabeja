...
public class SVGXLineGenerator extends AbstractSVGSAXGenerator{
	...
	public void toSAX(ContentHandler handler, Map svgContext, DXFEntity entity,
		...
		Point end = DXFUtils.getPointFromParameterizedLine(xline.getBasePoint(),xline.getDirection(),t);
        Point start = DXFUtils.getPointFromParameterizedLine(xline.getBasePoint(),xline.getDirection(),(-1*t));
