	...
	public void toSAX(ContentHandler handler, Map svgContext, DXFEntity entity,
		...
		if (imageDef != null) {
			...
			attr.addAttribute(SVGConstants.XLINK_NAMESPACE, "href",
					"xlink:href", "CDATA", SVGUtils.pathToURI(imageDef
							.getFilename()));
			...
			transform
					.append(SVGUtils
							.formatNumberAttribute((insertPoint.getX() + imageSizeAlongU / 2)));
			transform.append(SVGConstants.SVG_ATTRIBUTE_PATH_PLACEHOLDER);
			transform
					.append(SVGUtils
							.formatNumberAttribute((insertPoint.getY() + imageSizeAlongV / 2)));
			transform.append(")");
