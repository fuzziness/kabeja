...
public class SVGPolylineGenerator extends AbstractSVGSAXGenerator implements
			...
			if (pline.getStartWidth() > 0.0) {
				SVGUtils.addAttribute(attr,
						SVGConstants.SVG_ATTRIBUTE_STROKE_WITDH, SVGUtils
								.formatNumberAttribute(pline.getStartWidth()));
			}
	...
	protected void polyfaceToSAX(ContentHandler handler, Map svgContext,
		...
		while (i.hasNext()) {
			...
			if (v.isFaceRecord()) {
				...
				DXFVertex v1 = pline.getPolyFaceMeshVertex(v
						.getPolyFaceMeshVertex0());
				DXFVertex v2 = pline.getPolyFaceMeshVertex(v
						.getPolyFaceMeshVertex1());
				DXFVertex v3 = pline.getPolyFaceMeshVertex(v
						.getPolyFaceMeshVertex2());
				DXFVertex v4 = pline.getPolyFaceMeshVertex(v
	...
	protected void meshToSAX(ContentHandler handler, Map svgContext,
		...
		if (pline.isSimpleMesh()) {
			...
			Point[][] points = new Point[pline.getSurefaceDensityRows()][pline
