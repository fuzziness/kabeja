...
public class SVGSAXGeneratorManager {
	...
	protected void initialize() {
		...
		this.generators
				.put(DXFConstants.ENTITY_TYPE_ARC, new SVGArcGenerator());
		this.generators
		.put(DXFConstants.ENTITY_TYPE_ATTRIB, new SVGAttribGenerator());
		...
		this.generators.put(DXFConstants.ENTITY_TYPE_RAY,
				new SVGRayGenerator());
