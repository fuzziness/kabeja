...
public class OutputSettingsUI extends AbstractPropertiesEditor implements
		Serviceable, Component {

	private String[] papers = new String[] { "NoPapper", "A0", "A1", "A2",
			"A3", "A4", "A5", "A6", "Letter" };
	private String[] units = new String[] { "inch", "mm", "px" };

	private String[] layout = new String[] { "Modelspace", "Paperspace",
			"Kabeja" };
	...
	public void setServiceManager(ServiceManager manager) {
		Object[] objects = manager
				.getServiceComponents(ApplicationToolBar.SERVICE);
		for (int i = 0; i < objects.length; i++) {
			((ApplicationToolBar) objects[i]).addAction(new AbstractAction(
					"Paper Settings", new ImageIcon(UIUtils.resourceToBytes(
							this.getClass(), "/icons/paper_settings.gif"))) {
	...
	protected void init() {
		if (!this.initialized) {
			...
			panel.add(new JGoodiesSeparator("Paper Size"), createConstraints(0, 0, 3, 1,
					GridBagConstraints.HORIZONTAL, GridBagConstraints.CENTER,
					new Insets(0, 0, 8, 5)));

			panel.add(new JLabel("Paper"), createConstraints(0, 1, 1, 1,
					GridBagConstraints.NONE, GridBagConstraints.EAST));
			paperSelection = new JComboBox(papers);
			panel.add(paperSelection, createConstraints(1, 1, 2, 1,
					GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST));

			panel.add(new JLabel("Custom Paper"), createConstraints(0, 2, 1, 1,
					GridBagConstraints.NONE, GridBagConstraints.EAST,
					new Insets(8, 0, 1, 0)));
			...
			panel.add(customPaper, createConstraints(1, 2, 1, 1,
					GridBagConstraints.NONE, GridBagConstraints.WEST,
					new Insets(8, 0, 1, 0)));

			panel.add(new JLabel("Unit"), createConstraints(0, 3, 1, 1,
					GridBagConstraints.NONE, GridBagConstraints.EAST));
			unitSelection = new JComboBox(units);
			panel.add(unitSelection, createConstraints(1, 3, 2, 1,
					GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST));

			panel.add(new JLabel("Width"), createConstraints(0, 4, 1, 1,
					GridBagConstraints.NONE, GridBagConstraints.EAST));
			widthField = new JTextField(20);

			panel.add(widthField, createConstraints(1, 4, 2, 1,
					GridBagConstraints.BOTH, GridBagConstraints.WEST));

			panel.add(new JLabel("Height"), createConstraints(0, 5, 1, 1,
					GridBagConstraints.NONE, GridBagConstraints.EAST));
			heightField = new JTextField(20);
			panel.add(heightField, createConstraints(1, 5, 2, 1,
					GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST));


			panel.add(new JGoodiesSeparator("Orientation"), createConstraints(0, 6, 3, 1,
					GridBagConstraints.HORIZONTAL, GridBagConstraints.CENTER,
					new Insets(25, 0, 1, 5)));
			...
			panel.add(landscapeSelection, createConstraints(1, 7, 2, 1,
					GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST));

			JRadioButton b = new JRadioButton("Portrait");
			b.setSelected(true);
			group.add(b);
			panel.add(b, createConstraints(1, 8, 2, 1,
					GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST));


			panel.add(new JGoodiesSeparator("Layout"), createConstraints(0, 9, 3, 1,
					GridBagConstraints.HORIZONTAL, GridBagConstraints.CENTER,
					new Insets(25, 0, 1, 5)));

			layoutSelection = new JComboBox(layout);
			panel.add(layoutSelection, createConstraints(1, 10, 2, 1,
					GridBagConstraints.HORIZONTAL, GridBagConstraints.WEST));
			...
			panel.add(button, createConstraints(2, 11, 1, 1,
					GridBagConstraints.NONE, GridBagConstraints.EAST,
					new Insets(12, 0, 1, 0)));
	...
	protected GridBagConstraints createConstraints(int x, int y, int width,
		...
		return createConstraints(x, y, width, height, fill, anchor, new Insets(
				1, 0, 1, 0));
	}
	...
	protected void updateProperties() {
		if (this.customPaper.isSelected()) {
			// custom paper
			this.properties
					.put(AbstractSAXSerializer.PROPERTY_PAPER, "NoPaper");
			this.properties
					.put(AbstractSAXSerializer.PROPERTY_WIDTH, this.widthField
							.getText()
							+ unitSelection.getSelectedItem());
		...
		this.properties.put(SVGGenerator.PROPERTY_DOCUMENT_BOUNDS_RULE, this.layoutSelection.getSelectedItem().toString().toLowerCase());
