...
public class ParametricPlane {
	...
	public double[] getParameter(Point p) {
		...
		if (v != 0.0) {
			v = (p.getY() * this.directionY.getX() - this.base.getY()
					* this.directionY.getX() - this.directionY.getY()
					* p.getX() + this.base.getX() * this.directionY.getY())
					/ v;
		}

		if (this.directionY.getX() != 0.0) {
			u = (p.getX() - this.base.getX() - this.directionX.getX() * v)
					/ this.directionY.getX();
		} else if (this.directionY.getY() != 0.0) {
			u = (p.getY() - this.base.getY() - this.directionX.getY() * v)
					/ this.directionY.getY();
		} else if (this.directionY.getY() != 0.0) {
			u = (p.getZ() - this.base.getZ() - this.directionX.getZ() * v)
					/ this.directionY.getZ();
		}
