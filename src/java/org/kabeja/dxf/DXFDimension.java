...
import org.kabeja.svg.dimension.LinearDimensionOutputter;
...
public class DXFDimension extends DXFEntity {
    ...
    public Bounds getBounds() {
        ...
        if (this.doc.getDXFBlock(this.dimensionBlock) != null) {
            ...
            if (b.isValid()) {
                bounds.setMaximumX(b.getWidth() + insertPoint.getX());
                bounds.setMaximumY(b.getHeight() + insertPoint.getY());
                bounds.setMinimumX(insertPoint.getX());
                bounds.setMinimumY(insertPoint.getY());
                return bounds;
            }
        }
