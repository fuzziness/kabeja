...
public class DXFDimensionHandler extends AbstractEntityHandler {
    ...
    protected final int GROUPCODE_REFERENCE_POINT_X = 10;
    protected final int GROUPCODE_REFERENCE_POINT_Y = 20;
    protected final int GROUPCODE_REFERENCE_POINT_Z = 30;
    protected final int GROUPCODE_TEXT_POINT_X = 11;
    protected final int GROUPCODE_TEXT_POINT_Y = 21;
    protected final int GROUPCODE_TEXT_POINT_Z = 31;
    protected final int GROUPCODE_INSERT_POINT_X = 12;
    protected final int GROUPCODE_INSERT_POINT_Y = 22;
    protected final int GROUPCODE_INSERT_POINT_Z = 32;
    protected final int GROUPCODE_REFERENCE_POINT3_X = 13;
    protected final int GROUPCODE_REFERENCE_POINT3_Y = 23;
    protected final int GROUPCODE_REFERENCE_POINT3_Z = 33;
    protected final int GROUPCODE_REFERENCE_POINT4_X = 14;
    protected final int GROUPCODE_REFERENCE_POINT4_Y = 24;
    protected final int GROUPCODE_REFERENCE_POINT4_Z = 34;
    protected final int GROUPCODE_REFERENCE_POINT5_X = 15;
    protected final int GROUPCODE_REFERENCE_POINT5_Y = 25;
    protected final int GROUPCODE_REFERENCE_POINT5_Z = 35;
    protected final int GROUPCODE_REFERENCE_POINT6_X = 16;
    protected final int GROUPCODE_REFERENCE_POINT6_Y = 26;
    protected final int GROUPCODE_REFERENCE_POINT6_Z = 36;
    protected final int GROUPCODE_DIMENSION_STYLE = 3;
    protected final int GROUPCODE_DIMENSION_BLOCK = 2;
    protected final int GROUPCODE_DIMENSION_AREA = 67;
    protected final int GROUPCODE_DIMENSION_TEXT = 1;
    protected final int GROUPCODE_LEADINGLINE_LENGTH = 40;
    protected final int GROUPCODE_DIMENSION_ROTATE = 50;
    protected final int GROUPCODE_HORIZONTAL_ALIGNMENT = 51;
    protected final int GROUPCODE_INCLINATION_HELPLINE = 52;
    protected final int GROUPCODE_TEXT_ROTATION = 53;
    protected final int GROUPCODE_DIMENSION_TYPE = 70;
