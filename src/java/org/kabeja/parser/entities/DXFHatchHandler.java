...
public class DXFHatchHandler extends AbstractEntityHandler {
    ...
    public static final int GROUPCODE_BOUNDARY_PATH_COUNT_NON_POLYLINE = 93;
    ...
    protected HatchLinePattern linePattern;
    ...
    public void endDXFEntity() {
        ...
        if (this.pattern != null) {
            this.hatch.setPatternID(this.pattern.getId());
        }
    }
    ...
    public void parseGroup(int groupCode, DXFValue value) {
        ...
        case GROUPCODE_BOUNDARY_EDGE_TYPE:
            ...
            if (boundaryHandler != null) {
                ...
                boundaryHandler.endDXFEntity();
                loop.addBoundaryEdge(boundaryHandler.getDXFEntity());
            }
        ...
        case GROUPCODE_BOUNDAYY_LOOP_TYPE:
            ...
            if (this.polylineBoundary) {
                // add the last parsed polyline
                this.loop.addBoundaryEdge(polyline);
            }
        ...
        case GROUPCODE_PATTERN_LINE_ANGLE:
            this.parseBoundary = false;
            this.linePattern = new HatchLinePattern();
            this.pattern.addLinePattern(this.linePattern);
    ...
    protected void parsePolylineBoundary(int groupCode, DXFValue value) {
        ...
        case 73:
            ...
            // the closed flag other here then 70
            if ((value.getIntegerValue() & 1) == 1) {
