	...
	public void parseGroup(int groupCode, DXFValue value) {
		...
		case GROUPCODE_BOUNDARY_EDGE_TYPE:
			...
			if (!this.polylineBoundary) {
				...
				case 1:
					boundaryHandler = (DXFEntityHandler) boundaryHandlers
							.get(DXFConstants.ENTITY_TYPE_LINE);
				...
				case 2:
					boundaryHandler = (DXFEntityHandler) boundaryHandlers
							.get(DXFConstants.ENTITY_TYPE_ARC);
					boundaryHandler.startDXFEntity();
				...
				case 3:
					boundaryHandler = (DXFEntityHandler) boundaryHandlers
							.get(DXFConstants.ENTITY_TYPE_ELLIPSE);
					boundaryHandler.startDXFEntity();
				...
				case 4:
					boundaryHandler = (DXFEntityHandler) boundaryHandlers
							.get(DXFConstants.ENTITY_TYPE_SPLINE);
					boundaryHandler.startDXFEntity();
